...
! m*2 gauza gorde ditut, auzoko eta bektoreak tartekatzen baitira fitxategian, beraz do-an kontutan hartu
  ...
  write(unit=43,fmt="(a,i5,a)") 'splot "datuBektoreak.dat" index', 0,' using 1:2:3 pt 7 ps 1 notitle,\'           ! puntu hodeia marraztu
  !write(unit=43,fmt="(a,i5,a)") '"datuBektoreak.dat" index', 1,' using 1:2:3 pt 7 ps 1 notitle,\'

  do i=1,i_kopurua*2,2 ! m*2 gauza, binaka kontatuz, ze berruan ya daukagu i+1 indizea          
    !write(unit=43,fmt="(a,i5,a)") '"datuBektoreak.dat" index', i,' using 1:2:3 pt 7 ps 1 notitle,\'
    write(unit=43,fmt="(a,i5,a)") '"datuBektoreak.dat" index', i,' using 1:2:3 pt 7 ps 1 notitle,\'               ! auzokoak marraztu
    write(unit=43,fmt="(a,i5,a)") '"datuBektoreak.dat" index', i+1,' using 1:2:3:4:5:6 w vectors lw 2 lt rgb "black" notitle,\'  ! bektoreak marraztu
  enddo

  !write(unit=43,fmt="(a,i5,a)") '"datuBektoreak.dat" index', 13-1,' using 1:2:3 pt 7 ps 1 notitle'
  write(unit=43,fmt="(a,i5,a)") '"datuBektoreak.dat" index', i_kopurua*2-1,' using 1:2:3 pt 7 ps 1 notitle,\'          
  write(unit=43,fmt="(a,i5,a)") '"datuBektoreak.dat" index', i_kopurua*2,' using 1:2:3:4:5:6 w vectors lw 2 lt rgb "black" notitle'     ! azkena ",\" ez izateko
