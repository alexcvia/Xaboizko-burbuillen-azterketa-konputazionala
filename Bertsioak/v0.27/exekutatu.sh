...
echo konpilatzen
ifort -o probatu_lokala tipos.f90 parametroak.f90 auzokoak.f90 funtzioak.f90 mcf_matrices.f90 lokala.f90 probatu_lokala.f90
...
:wq
EOF
sed -i '/grep -v/a ./probatu_lokala' bidali.sh   #<<<----- aldatu bidaliko den lana
