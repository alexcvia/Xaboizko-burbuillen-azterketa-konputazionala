...
real(kind=dp),dimension(:,:,:),allocatable:: Rij_gorde            ! distantzia erlatiboak gordetzeko, askotan behar baita
...
!
  ...
  ! lortu abiadura bektore erlatiboak sistema lokal bakoitzeko
    ...
    call lortu_Uij_gainazal(f(i,1:3),f(auzokoen_indizeak(j),1:3),ui,uj,i_oinarria,j_oinarria,Uij_gainazal) !(ri,rj,ui,uj,iren_oinarria,jren_oinarria,Uij_gainazal)
  ...
  ! algoritmo1
    ...
    !write(unit=43,fmt="(a,f20.14)")  "dibergentzia_j--->"    ,dibergentzia_j
    !write(unit=43,fmt="(a,f20.14)")  "kurbadura_lokala_j--->",kurbadura_lokala_j
  enddo
