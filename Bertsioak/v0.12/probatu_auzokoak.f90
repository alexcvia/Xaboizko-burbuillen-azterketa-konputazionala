...
!enddo
 ...
 do i=1,n-2
   write(unit=43,fmt="(a,i3,a)") '"datuauzokoak.dat" index', i,' using 1:2:3 pt 7 ps 1 notitle,\'
 enddo
 write(unit=43,fmt="(a,i3,a)") '"datuauzokoak.dat" index', n-1,' using 1:2:3 pt 7 ps 1 notitle'
