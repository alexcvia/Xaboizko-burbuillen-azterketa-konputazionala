...
echo konpilatzen
ifort -o probatu_bektoreak tipos.f90 parametroak.f90 auzokoak.f90 funtzioak.f90 mcf_matrices.f90 lokala.f90 bektoreak.f90 probatu_bektoreak.f90
...
:wq
EOF
sed -i '/grep -v/a ./probatu_bektoreak' bidali.sh   #<<<----- aldatu bidaliko den lana
