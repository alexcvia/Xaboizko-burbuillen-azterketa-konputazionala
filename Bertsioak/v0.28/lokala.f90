...
public :: i_ren_tentsore_metrikoa 
...
subroutine i_ren_tentsore_metrikoa(iren_oinarria,g,g_1,det_g,det_g_1)
  ...
  real(kind=dp),dimension(3)                :: e1,e2         

  e1(1:3)=iren_oinarria(1:3,1) ! i-ren 1.autobektorea (gogoratu output-ean zutabea dela)
  e2(1:3)=iren_oinarria(1:3,2) ! i-ren 2.autobektorea

  g(1,1:2)=(/sum(e1*e1),sum(e1*e2)/)
  g(2,1:2)=(/sum(e2*e1),sum(e2*e2)/)
...
endsubroutine i_ren_tentsore_metrikoa 
endmodule lokala
