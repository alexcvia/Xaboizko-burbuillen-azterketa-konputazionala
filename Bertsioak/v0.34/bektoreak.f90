...
subroutine lortu_ij_tentsore_metrikoa(p_guztiak,indizea,iren_auzo,iren_oinarria,g,g_1,det_g,det_g_1) 
  ...
  real(kind=dp),dimension(:,:),allocatable  :: askatu   ! askatu behar dugun sistemalinealaren A matrizea
  real(kind=dp),dimension(6)                :: soluzioa ! gainazal hurbilketa funtzioaren parametroak (sistemaren b bektorea)
