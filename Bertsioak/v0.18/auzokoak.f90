...
if (partikula_guztiak(i,j)<0) then
 write(unit=109,fmt=*) "(3 errorea) arazoa auzokoak moduluan (30 lerroan):"  
...
if (erroZatiKop**3*erroPartikulaKop>10**9) then
 write(unit=109,fmt=*) "(1 errorea) arazoa auzokoak moduluan (209 lerroan):"  
...
!  xsareKoordMin=minval(sare_zati_bilduma(:,1))      !lortu sare zati x indize minimoa, sare_zati huts gutsien sortzeko
