...
echo konpilatzen
ifort -o probatu_indarrak tipos.f90 parametroak.f90 auzokoak.f90 funtzioak.f90 mcf_matrices.f90 lokala.f90 bektoreak.f90 prestaketa.f90 indarrak.f90 muga.f90 probatu_indarrak.f90
