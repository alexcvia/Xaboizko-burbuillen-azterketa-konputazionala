...
!azelerazio grabitatorioa
  ...
  real(kind=dp),parameter::  grabitate     = -9.81_dp*0.00000001      ! (m/s**2)
...
!kanpo indar extrak
  real(kind=dp),dimension(3),parameter:: extra_indarra_1    = (/0.001_dp,0.0_dp,0.0_dp/)  ! kanpo indar 1
