...
zmin_plot=1.0183172_dp
zmax_plot=1.0200010_dp

  write(unit=52,fmt="(a)") 'set hidden3d'                                                                ! gnuplot prestatu
  write(unit=52,fmt="(a)") 'set palette defined'                                                              ! gnuplot prestatu
  ...
  write(unit=52,fmt="(a)")                 'set cbrange [1.0e-7:1.0e-6]'                                    ! 10**-4
  do i=0,3387-1 !0-tik hasi behar index-erako
