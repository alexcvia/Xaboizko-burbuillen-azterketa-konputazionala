...
!denbora pausua
  ...
  integer,parameter      ::  t_total       = 1000
...
!kalibrazio parametroak
  ...
  real(kind=dp),parameter::  alpha_b       = 1.0e+0_dp              ! biskositate indarraren eragina
...
!========================================= Hasierako Baldintzak ===========================================================
 ...
 !atseden bortizitatea:
  real(kind=dp),parameter::  bortizitate_0    = 1.0e-6_dp             ! (kg/s**2) a ojo
