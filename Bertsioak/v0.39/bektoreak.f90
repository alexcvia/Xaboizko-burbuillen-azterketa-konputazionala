...
write(unit=45,fmt="(f20.14,a)")  k, "k"
write(unit=45,fmt="(f20.14,a)")  gainazal_gradientea(1), "gainazal_gradientea(1)"
write(unit=45,fmt="(f20.14,a)")  gainazal_gradientea(2), "gainazal_gradientea(2)"
