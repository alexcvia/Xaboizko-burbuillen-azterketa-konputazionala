...
public :: lortu_i_ren_sistema_lokala 
!private :: lortu_i_ren_sistema_lokala 
!public  :: lortu_sistema_lokalen_zerrenda 


contains
subroutine lortu_i_ren_sistema_lokala(p_guztiak,indizea,iren_auzo,iren_oinarria) 
...
endsubroutine lortu_i_ren_sistema_lokala
!----------------------------------------------------------------------------------
!----------------------------------------------------------------------------------
!----------------------------------------------------------------------------------
!subroutine lortu_sistema_lokalen_zerrenda(p_guztiak,oinarri_zerrenda)
!
!  real(kind=dp),intent(in),dimension(:,:)      :: p_guztiak  ! partikula guztien zerrenda
!  real(kind=dp),intent(out),dimension(:,:)     :: p_guztiak  ! partikula guztien zerrenda
!  
!  
!
!endsubroutine lortu_sistema_lokalen_zerrenda
endmodule lokala
