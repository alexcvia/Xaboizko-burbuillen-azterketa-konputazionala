...
subroutine i_ren_sistema_lokala(p_guztiak,indizea,iren_auzo,iren_oinarria) 
  ...
  real(kind=dp),dimension(3,3)                 :: diagonal
  real(kind=dp),dimension(3,3)                 :: estradiagonal 
...
call tred2(kobariantza_matrizea,diagonal,estradiagonal)  ! kobariantza matrizea hiru-diagonal bihurtu (bertan gorde)
call tqli(diagonal,estradiagonal,kobariantza_matrizea)   ! autobalioak ("diagonal" barruan bueltatu) eta autobektoreak (kobariantza matrize zutabeetan)
