...
! lortu sistema lokalaren oinarri bektoreak
  ...
  write(unit=42,fmt=*)
  write(unit=42,fmt=*)
  write(unit=42,fmt="(6f20.14)")  f(i_partikula,1:3),i_oinarria(1:3,1)*0.01
  write(unit=42,fmt="(6f20.14)")  f(i_partikula,1:3),i_oinarria(1:3,2)*0.01
  write(unit=42,fmt="(6f20.14)")  f(i_partikula,1:3),i_oinarria(1:3,3)*0.01
...
!
  ...
  ! algoritmo1
    call lortu_dibergentzia_j(Vi_0,hi_0,Uij_gainazal,gainazal_gradientea,dibergentzia_j)                !(Vj,hj,Uij,gainazal_gradientea,dibergentzia_j)
    call lortu_kurbadura_lokala_j(Vi_0,hi_0,hi_0,Rij_gainazal,gainazal_gradientea,kurbadura_lokala_j)   !(Vj,hj,hi,Rij,gainazal_gradientea,kurbadura_lokala_j)
  ...
  ! algoritmo1 bukatu
  call lortu_gainazal_tentsioa_i(kontzentrazioa_0,gainazal_tentsioa_i)                       !(xaboi_kontzentrazioa_i,gainazal_tentsioa_i)
  call lortu_presioa_i(hi_0,gainazal_tentsioa_i,kurbadura_lokala_i,dibergentzia_i,presioa_i) !(hi,gainazal_tentsioa_i,kurbadura_lokala_i,dibergentzia_i,presioa_i)
