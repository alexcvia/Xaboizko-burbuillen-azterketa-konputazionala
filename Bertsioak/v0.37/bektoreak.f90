...
subroutine lortu_Uij_gainazal(ri,rj,ui,uj,iren_oinarria,jren_oinarria,Uij_gainazal)
  ...
  Rij=ri-rj
write(unit=44,fmt="(3f20.14,a)") Rij, "Rij"

  i1_berri=Rij/norm2(Rij)      ! norm2 bektore baten modulua lortzen duen funtzio intrintsekoa da 
  j1_berri=i1_berri
write(unit=44,fmt="(3f20.14,a)") i1_berri, "i1_berri"
write(unit=44,fmt="(3f20.14,a)") j1_berri, "j1_berri"

  i2_berri=bektorial(ni,i1_berri)
  j2_berri=bektorial(nj,j1_berri)
write(unit=44,fmt="(3f20.14,a)") i2_berri, "i2_berri"
write(unit=44,fmt="(3f20.14,a)") j2_berri, "j2_berri"
...
write(unit=44,fmt="(f20.14,a)") ai, "ai"
write(unit=44,fmt="(f20.14,a)") bi, "bi"
write(unit=44,fmt="(f20.14,a)") aj, "aj"
write(unit=44,fmt="(f20.14,a)") bj, "bj"

  Uij_gainazal=(aj-ai)*i1_berri+(bj-bi)*i2_berri
write(unit=44,fmt="(3f20.14,a)") Uij_gainazal, "Uij_gainazal"
