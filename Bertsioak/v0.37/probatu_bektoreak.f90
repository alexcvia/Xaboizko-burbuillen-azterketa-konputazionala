...
! lortu abiadura bektore erlatiboak sistema lokal bakoitzeko
  ...
  do i=1,size(auzokoen_indizeak,1)
    ...
    write(unit=44,fmt="(6f20.14)")  f(auzokoen_indizeak(i),1:2),0.0_dp,Uij_gainazal(1:3) !soilik bektore bakar bat da (z=0 planoan marraztuko dugu)
  enddo
...
!  ez dut hasierako lerroa behar goian baitago, eta soilik fitxategi hasieran jarri behar baita
  ...
  write(unit=52,fmt="(a,i5,a)") '"datuBektoreak3.dat" index', i_kopurua,' using 1:2:3:4:5:6 w vectors lw 2 lt rgb "purple" notitle'  ! azkena ",\" ez izateko
