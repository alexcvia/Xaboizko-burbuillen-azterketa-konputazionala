...
!denbora pausua
  real(kind=dp),parameter::  delta_t       = 0.5_dp*R_auzo
...
!========================================= Hasierako Baldintzak ===========================================================
 ...
 !atseden bortizitatea:
  real(kind=dp),parameter::  bortizitate_0    = 0.0_dp               ! (kg/s**2)
 
!geometria hasieran
  integer,parameter      ::  npartikula_0  = 1e4                     ! ( )
  real(kind=dp),parameter::  luzera_x0     = 0.1_dp                  ! (m)
  real(kind=dp),parameter::  luzera_y0     = 0.1_dp                  ! (m)
