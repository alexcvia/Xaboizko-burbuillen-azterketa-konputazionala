...
! konprobatu ea normala ondo orientatuta dagoela gure simulazioaren baldintzetarako
  ...
  if (OrientazioPlanoGlobala=0.0_dp) then
        if (OrientazioGlobala*iren_oinarria(1:3,3)<0) then   ! normala ez badago "gora" begira, buelta eman oinarriari
          iren_oinarria(1:3,1)=-kobariantza_matrizea(1:3,3)
          iren_oinarria(1:3,2)=-kobariantza_matrizea(1:3,2)    
          iren_oinarria(1:3,3)=-kobariantza_matrizea(1:3,1)    
        endif                                                ! bestela ez egin ezer
  else
    if (OrientazioGlobala*(ibektore-OrientazioGlobala*OrientazioPlanoGlobala)>0) then
        ...
        if (OrientazioGlobala*iren_oinarria(1:3,3)>0) then   ! normala ez badago "bera" begira, buelta eman oinarriari
          iren_oinarria(1:3,1)=-kobariantza_matrizea(1:3,3)
          iren_oinarria(1:3,2)=-kobariantza_matrizea(1:3,2)    
          iren_oinarria(1:3,3)=-kobariantza_matrizea(1:3,1)    
        endif                                                ! bestela ez egin ezer
