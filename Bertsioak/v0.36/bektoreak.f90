...
subroutine lortu_Rij_gainazal(ri,rj,ni,Rij_gainazal)
  ...
  Rij=ri-rj
write(unit=43,fmt=*) ri ,"ri"
write(unit=43,fmt=*) rj ,"rj"
write(unit=43,fmt=*) ni ,"ni"
write(unit=43,fmt=*) Rij,"Rij"

  Rij_gainazal=Rij-sum(Rij*ni)*ni
write(unit=43,fmt=*) sum(Rij*ni)   ,"sum(Rij*ni)"
write(unit=43,fmt=*) sum(Rij*ni)*ni,"sum(Rij*ni)*ni"
write(unit=43,fmt=*) Rij_gainazal  ,"Rij_gainazal"
write(unit=43,fmt=*) "blablabla"
