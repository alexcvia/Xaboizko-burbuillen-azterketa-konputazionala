...
! definitu hasierako u eta bortizitatea
  ...
  do i=1,i_kopurua
    ...
    if ( (i>3000).and.(i<6000).and.( ((i-floor(i/100.0))*100)>30 ).and.( ((i-floor(i/100.0))*100)<60) ) then
      call random_number(random)
      u_gorde(i,1)=(random-0.5_dp)*0.01_dp ! (0,1) izatetik (-0.5,0.5) izatera pasatu zorizko zenbakia
      call random_number(random)
      u_gorde(i,2)=(random-0.5_dp)*0.01_dp
      !call random_number(random)
