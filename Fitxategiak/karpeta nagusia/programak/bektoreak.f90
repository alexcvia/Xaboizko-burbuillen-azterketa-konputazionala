...
public :: lortu_tentsore_metrikoa_i 
public :: lortu_Rij_gainazal
public :: lortu_Uij_gainazal
public :: lortu_gainazal_gradientea
public :: lortu_proiekzio_lokala

contains
subroutine lortu_tentsore_metrikoa_i(p_guztiak,indizea,iren_auzo,iren_oinarria,g,g_1,det_g,det_g_1) 
...
!====-----====
  ...
  deallocate(B)
  deallocate(B_T)
endsubroutine lortu_tentsore_metrikoa_i 
!----------------------------------------------------------------------------------
!----------------------------------------------------------------------------------
!----------------------------------------------------------------------------------
